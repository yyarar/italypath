...
Son guncelleme: 2026-09-21 · Dogrulandigi commit: `ab38759` · 2026-09-26: `check:offline` push kurali, canli veritabani ve skill guncelleme kurallari (guvenlik denetimi kart 11) · 2026-09-26: ceviri dosyasi ve framer-motion kurali (kart 10)
...
- Route guvenligi yalnizca `proxy.ts`; `middleware.ts` olusturma. Public/protected tek kaynak: `proxy.ts` + `AGENT_CONTEXT.md` "Auth ve Route Matrix". `/ai-mentor` public (gonullu + uzman masasi; AI masasi 2026-09-26'da kaldirildi), `/api/sat/*` ve `/ekip/*` protected. <!-- check-docs: ignore -->
...
- UI metinleri `lib/translations/tr.ts` + `en.ts` icinde TR/EN paralel (Ingilizce yalniz dinamik import); hard-code yok. framer-motion yalniz `LazyMotion` + `m`; layout/layoutId `LayoutMotion` icinde. Tailwind v4 token'lari `app/globals.css`; `tailwind.config.*` yok. Global state icin Context + mevcut hook'lar; Redux/Zustand/Jotai yok.
