    ...
    <div className="min-h-screen bg-white font-sans text-slate-800">
      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* MASAÜSTÜ MENÜSÜ (Büyük ekranlarda görünür) */}
            ...
            {/* MOBİL MENÜ (Telefonlarda görünür - Eksik olan burasıydı) */}
            <div className="md:hidden flex items-center gap-3">
              <button 
                onClick={toggleLanguage}
                className="font-bold text-slate-700 bg-slate-100 px-3 py-1.5 rounded-full text-xs flex items-center gap-1"
              >
              ...
              <SignedOut>
                <SignInButton mode="modal">
                  <span className="cursor-pointer bg-blue-600 text-white px-4 py-2 rounded-full text-xs font-medium shadow-md">
                    {t.navbar.login}
                  </span>
                </SignInButton>
              </SignedOut>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-7xl font-extrabold tracking-tight text-slate-900 mb-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">{t.hero.subtitle}</p>
          <div className="flex justify-center items-center">
            <Link href="/universities" className="px-10 py-4 bg-blue-600 text-white rounded-xl font-bold text-lg hover:bg-blue-700 transition shadow-xl shadow-blue-600/20 flex items-center justify-center">
      ...
      {/* ISEE HESAPLAYICI BÖLÜMÜ */}
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-[2.5rem] p-10 md:p-16 shadow-2xl relative overflow-hidden text-white">
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="text-center lg:text-left max-w-2xl">
                ...
                <h2 className="text-3xl md:text-5xl font-bold mb-6">{t.isee.homeCardTitle}</h2>
                <p className="text-blue-100 text-lg opacity-90">{t.isee.homeCardDesc}</p>
              </div>
              <Link href="/isee" className="group bg-white text-blue-700 px-10 py-5 rounded-2xl font-black text-xl hover:bg-blue-50 transition-all flex items-center">
                {t.isee.homeCardBtn}<ArrowRight className="ml-2 w-6 h-6 group-hover:translate-x-2 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-cols-4xl mx-auto">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100">
              <div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-6"><GraduationCap className="w-7 h-7 text-blue-600" /></div>
              <h3 className="text-xl font-bold mb-3">{t.features.card1Title}</h3>
              <p className="text-slate-600">{t.features.card1Desc}</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100">
              <div className="w-14 h-14 bg-orange-100 rounded-xl flex items-center justify-center mb-6"><MessageCircle className="w-7 h-7 text-orange-600" /></div>
              <h3 className="text-xl font-bold mb-3">{t.features.card2Title}</h3>
              <p className="text-slate-600">{t.features.card2Desc}</p>
            </div>
          </div>
        </div>
      </section>
