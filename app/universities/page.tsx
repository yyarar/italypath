...
// 👇 Dil kütüphanesini import ettik
...
export default function UniversitiesPage() {
  ...
  const filteredUniversities = universitiesData.filter((uni) => {
    ...
    const matchesFavorites = showFavoritesOnly ? favorites.includes(uni.id) : true;
    ...
    <div className="min-h-screen bg-slate-50 py-10 px-4 sm:px-10 lg:px-20">
      ...
      <div className="max-w-7xl mx-auto mb-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 max-w-5xl">
            ...
            <button
                ...
                className={`flex items-center justify-center px-6 py-4 rounded-xl font-bold transition-all shadow-lg border-2 whitespace-nowrap ${
                    showFavoritesOnly 
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        {filteredUniversities.length > 0 ? (
            ...
            // 👇 Dil kontrolü: İngilizce seçiliyse ve İngilizce veri varsa onu kullan
