...
Tarih: 2026-09-26 · Doğrulandığı commit: `771b995` · 2026-09-25: servis planları/kullanım (#1, #18, #21, #40-42) eklendi, kaynak `docs/USAGE_LIMITS.md` · 2026-09-25: Supabase yedek ve geri yükleme yolu (G2#2) kapandı, #43-45 eklendi · 2026-09-25: güvenlik kartı 5 (S3#3, S2#2, S2#4, G4#1), #53 eklendi · 2026-09-26: güvenlik kartı 2 (veri katmanı + egress), #1 güncellendi, #54 eklendi · 2026-09-26: kart 2 ve kart 5 main'e birleştirilip tek yayında push edildi · 2026-09-26: güvenlik kartı 4 (katalog yetkileri + kullanıcı yazma sınırları) canlı veritabanında; #52 ve #54 kapandı, #1 güncellendi, #55-58 eklendi
...
| 53 | Güvenlik kartı 5 yayını (denetim S3#3, S2#2, S2#4, G4#1). 2026-09-26'da main'e birleştirildi ve push edildi (kart 2 ile aynı yayın). **Yapıldı:** gönüllü masa Realtime okuma kuralları canlıda (2026-09-25 22:04 UTC, migration `volunteer_mentor_private_realtime`, Kerem onayı, önce 21:11 UTC yedeği `--verify` ile doğrulandı). Geri alınan canlı denemede gerçek 2 öğrenci + operatör kimliğiyle 10/10 giriş kararı doğru; öğrenci ve anonim yazma 42501 ile reddedildi. Anonimin Supabase'e ait yazma yetkisi kaldırılamadı, yazmayı RLS reddediyor. Canlıdaki herkese açık kanallar etkilenmez. Uzman formu şüpheli eşiği + 150 tavan da canlıda (2026-09-25 22:20 UTC, migration `expert_leads_suspected_threshold`, Kerem onayı, push öncesi). Geri alınan canlı denemede ilk 50 `new`, 51-150 `suspected` (100), 151. `expert_lead_rate_limited`, aynı gönderim tekrarı 23505; deneme satırı kalmadı. **Kalan sıra:** (1) yayın "Ready" olunca `/ekip/uzman` kontrolü, (2) iki hesaplı Realtime testi, (3) Supabase Realtime "Allow public access" kapatma, (4) testi tekrar. Panel ayarı yeni yayın canlı olmadan kapatılırsa masa canlı güncellemeyi kaybeder. Ayrıntı `SUPABASE_SECURITY_RUNBOOK.md` "Private Realtime" | `supabase/expert_leads.sql`, `supabase/volunteer_mentor.sql`, `npm run test:mentor-db` | Kerem: test, panel ayarı |
