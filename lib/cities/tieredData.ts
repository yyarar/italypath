...
export const TIERED_CITY_RECORDS = [
  ...
  },
  {
    ...
    transportDetails:
      "Pescara'da günlük öğrenci hareketliliği TUA'nın kent içi ve metropol alan ağına dayanır: belediye, 20 hatlık yaklaşık 300 km'lik bir kentsel ağ ve Chieti-Pescara metropol alanını kapsayan bütünleşik bağlantılar tanımlar. TUA da Pescara'nın kentsel hatlarıyla alan metropoliten bağlantılarını aynı resmî hat yapısı içinde listeler. Üniversite tarafında Ud'A'nın Pescara ayağı, Viale Pindaro'daki şehir içi kampüse dayanır; kurumun tarih sayfası da ateneonun baştan beri Chieti ve Pescara arasında paylaşılan iki kampüslü bir yapı olduğunu açıkça gösterir, bu yüzden öğrenciler için Pescara rehberi şehir içi yaşamı anlatırken Chieti'yi paralel kampüs olarak akılda tutmalıdır.",
    transportDetailsEn:
      "In Pescara, daily student mobility relies on TUA's urban and metropolitan network: the municipality describes an urban system of 20 lines across about 300 km, with integrated connections across the Chieti-Pescara metropolitan area. TUA likewise lists Pescara's urban lines together with the wider area network in the same official route structure. On the university side, Ud'A's Pescara footprint centers on the city-embedded Viale Pindaro campus, and the university's history page makes clear that the institution has long been structured across both Chieti and Pescara, so a Pescara guide should describe city life here while keeping Chieti in view as the parallel campus rather than a separate student-city split.",
    climateAndVibe:
