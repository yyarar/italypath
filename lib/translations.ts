export const translations = {
  tr: {
    ...
    features: {
      ...
      card2Title: "Danışma Masaları",
      card2Desc: "Hızlı bir yanıt için ItalyPath AI'a sor veya aynı yoldan geçmiş gönüllü ekibe yaz.",
  ...
  en: {
    ...
    features: {
      ...
      card2Title: "Consultation Desks",
      card2Desc: "Ask ItalyPath AI for a fast answer or write to the volunteer team who've walked the same path.",
