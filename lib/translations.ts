export const translations = {
  tr: {
    ...
    department: {
      ...
      aiContextNote: "Program adı ve bu dosyadaki belirsiz noktalar görüşmeye taşınır.",
      ...
      askAi: "Bu programı ItalyPath AI'a sor",
  ...
  en: {
    ...
    department: {
      ...
      aiContextNote: "The programme name and unresolved points in this dossier carry into the conversation.",
