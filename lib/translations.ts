  ...
  tr: {
    ...
    homeApple: {
      ...
      scholarships: {
        ...
        steps: ["Bölgeyi seç", "ISEE tahmini yap", "Resmi çağrıyı doğrula"],
        cta: "Burs haritasını aç",
      },
      application: {
  ...
  en: {
    ...
    homeApple: {
      ...
      scholarships: {
        ...
        steps: ["Choose a region", "Estimate your ISEE", "Verify the official call"],
        cta: "Open the scholarship map",
      },
      application: {
