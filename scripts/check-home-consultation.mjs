...
must(consultPage, '"@type": "FAQPage"', "FAQPage JSON-LD");
must(consultPage, "tr.homeFaq.items", "FAQPage görünen SSS ile aynı kaynaktan (tr.homeFaq.items)");
must(consultPage, "serializeJsonLd(", "FAQPage JSON-LD serializeJsonLd ile yazılmalı");
