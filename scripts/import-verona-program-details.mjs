...
// Usage: node scripts/import-verona-program-details.mjs [--dry-run | --apply --project-ref kskbnxxyviowmrlskwke]
const SCRIPT_KEY = "verona";
...
function previewDetailPayloads(plan) {
  return plan.resolvedRows.map(({ file, record, departmentRef }) => {
    const departmentId =
      typeof departmentRef === "string" && departmentRef.startsWith("new:") ? null : departmentRef;
